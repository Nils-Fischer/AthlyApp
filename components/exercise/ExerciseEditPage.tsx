...
export const ExerciseEditPage = forwardRef<ExerciseEditHandle, ExerciseEditPageProps>(
  ({ exercise, workoutExercise, onClose, onUpdate, onExercisePress }, ref) => {
    ...
    // Expose the save method through the ref
