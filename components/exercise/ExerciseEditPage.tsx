    ...
    <View className="flex-1 bg-background">
      ...
      <View className="pt-14 px-4 py-2 flex-row items-center justify-between border-b border-border">
        <View className="flex-row items-center">
          ...
          <Text className="text-lg font-semibold">Übung bearbeiten</Text>
        </View>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="p-4">
          <Card className="p-4 mb-6">
            <View className="flex-row gap-4">
              ...
              <View className="flex-1">
                ...
                <Text className="text-muted-foreground">{exercise.equipment}</Text>
                <View className="flex-row mt-2">
                  {exercise.primaryMuscles.map((muscle, index) => (
                    <Text key={index} className="text-xs bg-secondary/20 rounded-full px-2 py-1 mr-1">
                      {muscle}
                    </Text>
                  ))}
                </View>
          ...
          <Text className="text-base font-medium mb-4">Training Parameter</Text>
...
<View className="mb-6">
  ...
  <View className="flex-row items-center justify-between bg-secondary/10 p-4 rounded-xl shadow-sm">
    ...
    <Pressable 
      className="bg-background/50 px-6 py-2 rounded-lg"
      onPress={() => {}}
    >
      <TextInput
